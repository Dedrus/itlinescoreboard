...
{
    internal class GetRnumPacket : SendPacketBase
    {
        public const int Length = 12 + GetNumData.DataLength;
        private readonly Command _command = Command.GetRnum;
        ...
        public GetRnumPacket([NotNull] PhysicalAddress mac, byte scoreboardType, uint messageId,
